          ...
          <header class="logo1">
            ...
            <div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                  ...
                  <li><a href="#"><i class="fa fa-check-square-o nav_icon"></i><span>Order Management</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
                   ...
                   <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i>  <span> User Contact Form</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
                     <ul id="menu-academico-sub" >
                      <li id="menu-academico-boletim" ><a href="manage-contact.php">View</a></li>
                  ...
                  <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i>  <span> Career Job Form</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
                     <ul id="menu-academico-sub" >
                      <li id="menu-academico-boletim" ><a href="manage_career.php">View</a></li>
